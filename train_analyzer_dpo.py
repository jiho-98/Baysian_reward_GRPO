#!/usr/bin/env python3
"""Wrapper for GSM8K analyzer DPO training and optional posterior recompute."""
...
from gsm8k_learned_analyzer_utils import load_jsonl, validate_runtime_dpo_pair, write_json


DEFAULT_DATASET_DIR = "outputs/gsm8k_learned_analyzer/dpo_data"
DEFAULT_OUTPUT_DIR = "outputs/gsm8k_learned_analyzer/dpo_adapter"
DEFAULT_LOG_DIR = (
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Train analyzer DPO on GSM8K distillation data."
    )
    ...
    parser.add_argument("--init_adapter_path", required=True)
...
def main() -> None:
    ...
    if args.reference_adapter_path:
        train_cmd.extend(["--reference_adapter_path", args.reference_adapter_path])
    if args.bf16:
